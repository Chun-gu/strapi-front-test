      ...
      <section>
        ...
        <Styled.OrderList>
          ...
          <Styled.Product>
            ...
            <Styled.Info>
              <ImageWrapper width={10.4} height={10.4} borderRadius={1}>
                {/* <Image src={productImg} layout="fill" alt="제품 사진" /> */}
              </ImageWrapper>
              <div>
                <p>딥러닝 개발자 무릎 담요</p>
                <span>수량: 1개</span>
        ...
        <Styled.Shipment>
          ...
          <Styled.InputWrapper>
            ...
            {(errors.ordererMobile1 ||
              ...
              <Styled.Error>휴대폰 번호를 확인해 주시기 바랍니다.</Styled.Error>
            )}
          </Styled.InputWrapper>
          <Styled.InputWrapper>
            ...
            {errors.email?.type === "required" && (
              <Styled.Error>이메일 주소를 입력해 주시기 바랍니다.</Styled.Error>
            )}
            {errors.email?.type === "pattern" && (
              <Styled.Error>이메일 형식을 확인해 주시기 바랍니다.</Styled.Error>
            )}
          </Styled.InputWrapper>
          <h3>배송지 정보</h3>
          <Styled.InputWrapper>
